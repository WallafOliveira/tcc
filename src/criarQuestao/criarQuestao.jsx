...
/* Resumidamente, este código cria um componente React que renderiza um formulário de criação de questões com campos de texto para o enunciado e as alternativas (A, B, C, D). O estado é usado para rastrear o texto inserido pelo usuário nas alternativas, e a função handleInputChange é chamada quando o usuário digita em um campo de alternativa para atualizar o estado correspondente. O logotipo no cabeçalho é clicável e redireciona para a página inicial usando o hook de navegação do react-router-dom. */ 
